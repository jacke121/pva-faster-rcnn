...
class Detector(caffe.Net):
    ...
    def __init__(self, model_file, pretrained_file, mean=None,
        ...
        in_ = self.inputs[0]
        self.transformer = caffe.caffe_io.Transformer(
    ...
    def detect_windows(self, images_windows):
        ...
        for image_fname, windows in images_windows:
            image = caffe.caffe_io.load_image(image_fname).astype(np.float32)
    ...
    def crop(self, im, window):
        ...
        if self.context_pad:
            ...
            context_crop = caffe.caffe_io.resize_image(context_crop, (crop_h, crop_w))
